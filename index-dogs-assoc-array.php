...
$dogs = json_decode(file_get_contents("dogs.json"), true);
// true It'll turn the output into an associative array instead of objects
...
<body>
    <div class="container py-5">
        <h1 class="display-2 text-center mb-5">Our Dogs (associative array)</h1>
